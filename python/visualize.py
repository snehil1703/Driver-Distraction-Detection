...
import sys
sys.path.append('/N/soft/cle5/caffe/20170112/caffe-master/.build_release/lib')
import caffe
...
net = caffe.Net('/N/dc2/scratch/snehvish/caffe/models/finalproject/deploy.prototxt','/N/dc2/scratch/snehvish/caffe/models/finalproject/finalproject_iter_10000.caffemodel',caffe.TEST)
